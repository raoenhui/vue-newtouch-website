...
<script>
  export default {
    ...
    mounted: function () {
          if(this.$route.path=="/program/scheme"){
            this.showBg=false;
          }else{
            this.showBg=true;
...
<style scoped>
  ...
  .program .program-nav a.router-link-active > .program-nav-line:not(.program-nav-headtit) {
    border-left: 5px solid #092d44;
  }

  .program .program-nav .program-nav-line {
    line-height: 40px;
    padding-left: 20px;
